...
VFuncHook::VFuncHook() : class_base(nullptr), vftbl_len(0), new_vftbl(nullptr), old_vftbl(nullptr) { }
VFuncHook::VFuncHook(void* base) : class_base(base), vftbl_len(0), new_vftbl(nullptr), old_vftbl(nullptr) { }
...
bool VFuncHook::Attach(void* base /*= nullptr*/)
{
	if (base != nullptr)
		class_base = base;
...
std::size_t VFuncHook::estimate_vftbl_length(std::uintptr_t* vftbl_start)
{
	auto len = std::size_t{};
